...
CLAIMS = [
    ...
    Claim(
        ...
        "2.250",
        "0.024",
        markers=("cumulative", "0.064", "0.024"),
    ),
    Claim(
        "Figure 4K",
    ...
    Claim(
        ...
        se_column="SE",
        p_column="p",
        markers=("Recurrence", "0.026", "0.003"),
    ),
    Claim(
        "Figure 6X",
        ...
        se_column="SE",
        p_column="p",
        markers=("Recurrence", "-0.033", "0.006"),
    ),
    Claim(
        "Figure 6Y",
        ...
        se_column="SE",
        p_column="p",
        markers=("Determinism", "0.010", "0.005"),
    ),
    Claim(
        "Figure 6Z",
