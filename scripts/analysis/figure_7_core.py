...
def write_report(
    ...
    lines = [
        ...
        "- `supplementary_figure5_prospective_paper_palette.png/.pdf/.svg`",
        "- `supplementary_figure5_feature_expansion_named_cohorts.png/.pdf/.svg`",
        "- `supplementary_figure5_all_parameter_importance.png/.pdf/.svg`",
        "- `supplementary_figure5_cumulative_features_time.png/.pdf/.svg`",
